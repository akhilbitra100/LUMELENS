    ...
    const fetchPhotos = async () => {
      ...
      try {
        const response = await axios.get(
          "http://localhost:4000/photos?category=Event%20Photography"
        );
    ...
    return (
      <div className="flex justify-center items-center h-64">
        <div className="animate-pulse flex flex-col items-center">
          ...
          <p className="mt-4 text-amber-500 font-medium">Loading events...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="container mx-auto p-8 text-center bg-gray-50 rounded-xl shadow-sm my-8">
        ...
        <p className="text-gray-600 text-xl font-medium">
          No event photographs are currently available.
        </p>
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-10">
      <div className="container mx-auto px-4 pt-8">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-amber-600 to-rose-700 rounded-2xl shadow-lg mb-8 overflow-hidden">
          <div className="max-w-4xl mx-auto py-12 px-6 md:px-12 md:flex md:items-center md:justify-between">
            <div className="text-center md:text-left md:max-w-lg">
              <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">Event Photography</h1>
              <p className="text-amber-100 text-lg mb-6">
                Capture your special moments with our professional event photography services.
              </p>
              {!user && (
        ...
        <div className="flex flex-wrap gap-3 mb-6 md:justify-between items-center">
          ...
          <p className="text-gray-600 font-medium">{filteredImages.length} events found</p>
        </div>
        ...
        {filteredImages.length === 0 && (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-medium text-gray-700 mb-2">No matching events found</h3>
